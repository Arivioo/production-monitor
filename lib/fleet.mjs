...
export const FALLBACK_FLEET = [
  { name: 'ReplyFlow',        repo: 'Arivioo/ReplyFlow',        dir: 'replyflow',        gates: 'required', staged: true,  branch: 'main' },
  { name: 'SignalScore',      repo: 'Arivioo/signalscore',      dir: 'signalscore',      gates: 'required', staged: true,  branch: 'main' },
  { name: 'ChannelMover',     repo: 'Arivioo/ChannelMover',     dir: 'ChannelMover',     gates: 'required', staged: true,  branch: 'main' },
  { name: 'BoatBuddy',        repo: 'Arivioo/BoatBuddy',        dir: 'BoatBuddy',        gates: 'required', staged: true,  branch: 'main' },
  { name: 'BackOffice',       repo: 'Arivioo/BackOffice',       dir: 'BackOffice',       gates: 'required', staged: false, branch: 'main' },
  { name: 'Valrano',          repo: 'Arivioo/Valrano',          dir: 'Valrano',          gates: 'required', staged: true,  branch: 'main' },
  { name: 'ScoutCopilot',     repo: 'Arivioo/ScoutCopilot',     dir: 'ScoutCopilot',     gates: 'required', staged: false, branch: 'master' },
  { name: 'Distribution-OS',  repo: 'Arivioo/Distribution-OS',  dir: 'Distribution-OS',  gates: 'required', staged: false, branch: 'master' },
  { name: 'launchready',      repo: 'Arivioo/launchready',      dir: 'launchready',      gates: 'deferred', staged: false, branch: 'master' },
  { name: 'arivioo',          repo: 'Arivioo/Cursor_Arivioo',   dir: 'arivioo',          gates: 'required', staged: false, branch: 'main' },
  { name: 'jass-tour-ui-kit', repo: 'Arivioo/jass-tour-ui-kit', dir: 'jass-tour-ui-kit', gates: 'required', staged: false, branch: null },
  { name: 'predivo',          repo: 'Arivioo/predivo',          dir: 'predivo',          gates: 'na',       staged: false, branch: 'master' },
]
